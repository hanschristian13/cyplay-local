...
const Sertification = () => {
  return (
    <div className='relative flex flex-col gap-y-6 px-[17px]'>
      ...
      <p className='text-center'>CYPLAY RNG is certified by BMM, meeting strict international gaming standards. This certification ensures top-quality gaming performance and sets a high industry benchmark.</p>
      <Image
        alt='sertification'
